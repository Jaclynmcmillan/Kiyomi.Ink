...
// 👉 Import your local service photos (ONE level up, same as Hero.tsx)
  ...
  return (
    <section id="services" className="py-24 bg-brand-cream text-brand-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="group cursor-pointer">
            ...
            <p className="text-gray-600 font-light leading-relaxed mb-4">
              Achieve hyper-realistic, fluffy brows or a soft, powdered makeup look. I utilize advanced techniques to
              create shape and density that blends seamlessly with your natural hair.
            </p>
          ...
          <div className="group cursor-pointer md:mt-16">
            ...
            <p className="text-gray-600 font-light leading-relaxed mb-4">
              Add a touch of sparkle to your smile. Using high-quality lead-free crystals and gold charms, applied
              safely with dental-grade adhesive. Expressive, playful, and non-damaging.
            </p>
        ...
        {/* Coming soon */}
        <div className="mt-24 text-center border-top border-brand-black/10 pt-16">
